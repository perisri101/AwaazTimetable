...
def fix_activity_categories():
    """Fix activity categories directory inconsistency"""
    # Path to incorrect directory
    incorrect_dir = os.path.join(DATA_DIR, 'activity_categorys')
    
    # Path to correct directory
    correct_dir = os.path.join(DATA_DIR, 'activity_categories')
    ...
    logger.info("Contents of activity_categories directory:")
